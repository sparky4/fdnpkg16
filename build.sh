...
#wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg     -we -d0 -k21800 -fpi -i=src -i=src/zlib -i=src/watt32/inc -fe=fdnpkg16.exe src/*.c src/zlib/zlib_l.lib src/watt32/lib/wattcpwl.lib
rm *.o
wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k24576 -fpi -DNOREPOS -DNOLZMA -i=src -i=src/zlib -fe=fdinst16.exe src/exec/fdinst16.c src/crc32.c src/fileexst.c src/getdelim.c src/helpers.c src/inf.c src/libunzip.c src/loadconf.c src/lsm.c src/parsecmd.c src/pkginst.c src/pkgrem.c src/readenv.c src/rtrim.c src/showinst.c src/exec/kprintf0.c src/zlib/zlib_l.lib
rm *.o
echo "==============================================================================="
...
#00wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k24576 -fpi -i=src -fe=test-fn.exe src/exec/test-fn.c
echo "==============================================================================="
wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k24576 -fpi -i=src -i=src/zlib -fe=fdnpkg16.exe src/crc32.c src/fileexst.c src/kprintf.c src/loadconf.c src/parsecmd.c src/pkginst.c src/readenv.c src/getdelim.c src/inf.c src/libgz.c src/lsm.c src/parseurl.c src/pkgrem.c src/rtrim.c src/fdnpkg16.c src/helpers.c src/kitten.c src/libunzip.c src/pkgdb.c src/pkgsrch.c src/memcore.c src/showinst.c src/lzmadec.c src/zlib/zlib_l.lib
echo "==============================================================================="
wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k24576 -fpi -i=src -i=src/watt32/inc -fe=httpget.exe src/exec/httpget.c src/net.c src/http.c src/parseurl.c src/helpers.c src/watt32/lib/wattcpwl.lib
echo "==============================================================================="
upx --8086 -9 fdinst16.exe
upx --8086 -9 fdnpkg16.exe
#00upx --8086 -9 test-fn.exe
