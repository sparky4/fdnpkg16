...
wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k24576 -i=src -i=src/zlib -i=src/watt32/inc -fe=fdnpkg86.exe src/*.c src/zlib/zlib_l.lib src/watt32/lib/wattcpwl.lib
...
wcl -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k24576 -fpi -i=src -i=src/zlib -i=src/watt32/inc -fe=httpget.exe src/exec/httpget.c src/net.c src/http.c src/parseurl.c src/helpers.c src/dbg.c src/zlib/zlib_l.lib src/watt32/lib/wattcpwl.lib
