...
struct ziplist *pkginstall_preparepackage(struct pkgdb *pkgdb, char *pkgname, char *tempdir, char *localfile, int nosourceflag, char **repolist, FILE **zipfd, char *dosdir, struct customdirs *dirlist, char *buffmem1k, char *mapdrv);
