...
const char * W32_CALL wattcpVersion (void)
{
  ...
  #define CC_DEFINE      "__BORLANDC__"
    ...
    #define CFLAGS_BUF   "build/borland/win32/cflagbuf.h"
    #define CC_PROG      "bcc32"

  #elif defined(__FLAT__)
    #define CFLAGS       "build/borland/flat/cflags.h"
    #define CFLAGS_BUF   "build/borland/flat/cflagbuf.h"
    #define CC_PROG      "bcc32"

  #elif defined(__LARGE__)
    #define CFLAGS       "build/borland/large/cflags.h"
    #define CFLAGS_BUF   "build/borland/large/cflagbuf.h"
    #define CC_PROG      "bcc"

  #elif defined(__SMALL__)
    #define CFLAGS       "build/borland/small/cflags.h"
    #define CFLAGS_BUF   "build/borland/small/cflagbuf.h"
    #define CC_PROG      "bcc"
  #endif
  ...
  #define CC_PROG        "dmc"
    ...
    #define CFLAGS_BUF   "build/digmars/large/cflagbuf.h"

  #elif defined(WIN32)
    #define CFLAGS       "build/digmars/win32/cflags.h"
    #define CFLAGS_BUF   "build/digmars/win32/cflagbuf.h"

  #elif (DOSX == PHARLAP)
    #define CFLAGS       "build/digmars/phar/cflags.h"
    #define CFLAGS_BUF   "build/digmars/phar/cflagbuf.h"

  #elif (DOSX == X32VM)
    #define CFLAGS       "build/digmars/x32vm/cflags.h"
    #define CFLAGS_BUF   "build/digmars/x32vm/cflagbuf.h"
  ...
  #define CC_PROG        "pocc"
    ...
    #define CFLAGS_BUF     "build/pellesc/64bit/cflagbuf.h"
  #else
    #define CFLAGS         "build/pellesc/32bit/cflags.h"
    #define CFLAGS_BUF     "build/pellesc/32bit/cflagbuf.h"
  #endif
  ...
  #define CC_PROG        "clang-cl"
    ...
    #define CFLAGS_BUF   "build/clang/64bit/cflagbuf.h"
  #else
    #define CFLAGS       "build/clang/32bit/cflags.h"
    #define CFLAGS_BUF   "build/clang/32bit/cflagbuf.h"
  #endif
  ...
  #define CC_DEFINE      "__WATCOMC__"
    ...
    #define CFLAGS_BUF   "build/watcom/win32/cflagbuf.h"
    #define CC_PROG      "wcc386"

  #elif defined(__SMALL__)
    #define CFLAGS       "build/watcom/small/cflags.h"
    #define CFLAGS_BUF   "build/watcom/small/cflagbuf.h"
    #define CC_PROG      "wcc"

  #elif defined(__LARGE__)
    #define CFLAGS       "build/watcom/large/cflags.h"
    #define CFLAGS_BUF   "build/watcom/large/cflagbuf.h"
    #define CC_PROG      "wcc"

  #elif defined(__FLAT__)
    #define CFLAGS       "build/watcom/flat/cflags.h"
    #define CFLAGS_BUF   "build/watcom/flat/cflagbuf.h"
    #define CC_PROG      "wcc386"
  ...
  #define CC_PROG        "cl"
    ...
    #error "Quick-C small/large model no longer supported."
        ...
        #define CFLAGS_BUF  "build/visualc/64bit/debug/cflagbuf.h"
      #else
        #define CFLAGS      "build/visualc/32bit/debug/cflags.h"
        #define CFLAGS_BUF  "build/visualc/32bit/debug/cflagbuf.h"
      #endif
    #else
      #if defined(_WIN64)
        #define CFLAGS      "build/visualc/64bit/release/cflags.h"
        #define CFLAGS_BUF  "build/visualc/64bit/release/cflagbuf.h"
      #else
        #define CFLAGS      "build/visualc/32bit/release/cflags.h"
        #define CFLAGS_BUF  "build/visualc/32bit/release/cflagbuf.h"
      #endif
    #endif
  #endif
#endif
 ...
 */
   ...
   * Ref: cflagbuf.h rules in respective makefile.
   *
