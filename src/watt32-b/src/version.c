...
const char * W32_CALL wattcpVersion (void)
{
  ...
  #define CC_DEFINE      "__BORLANDC__"
    ...
    #define cflagbuf   "build/borland/win32/cflagbuf.h"
    #define CC_PROG      "bcc32"

  #elif defined(__FLAT__)
    #define CFLAGS       "build/borland/flat/cflags.h"
    #define cflagbuf   "build/borland/flat/cflagbuf.h"
    #define CC_PROG      "bcc32"

  #elif defined(__LARGE__)
    #define CFLAGS       "build/borland/large/cflags.h"
    #define cflagbuf   "build/borland/large/cflagbuf.h"
    #define CC_PROG      "bcc"

  #elif defined(__SMALL__)
    #define CFLAGS       "build/borland/small/cflags.h"
    #define cflagbuf   "build/borland/small/cflagbuf.h"
    #define CC_PROG      "bcc"
  #endif
  ...
  #define CC_PROG        "dmc"
    ...
    #define cflagbuf   "build/digmars/small/cflags.h"

  #elif defined(__LARGE__)
    #define CFLAGS       "build/digmars/large/cflags.h"
    #define cflagbuf   "build/digmars/large/cflagbuf.h"

  #elif defined(WIN32)
    #define CFLAGS       "build/digmars/win32/cflags.h"
    #define cflagbuf   "build/digmars/win32/cflagbuf.h"

  #elif (DOSX == PHARLAP)
    #define CFLAGS       "build/digmars/phar/cflags.h"
    #define cflagbuf   "build/digmars/phar/cflagbuf.h"

  #elif (DOSX == X32VM)
    #define CFLAGS       "build/digmars/x32vm/cflags.h"
    #define cflagbuf   "build/digmars/x32vm/cflagbuf.h"
  ...
  #define CC_PROG        "pocc"
    ...
    #define cflagbuf     "build/pellesc/64bit/cflagbuf.h"
  #else
    #define CFLAGS         "build/pellesc/32bit/cflags.h"
    #define cflagbuf     "build/pellesc/32bit/cflagbuf.h"
  #endif
  ...
  #define CC_PROG        "clang-cl"
    ...
    #define cflagbuf   "build/clang/64bit/cflagbuf.h"
  #else
    #define CFLAGS       "build/clang/32bit/cflags.h"
    #define cflagbuf   "build/clang/32bit/cflagbuf.h"
  #endif
  ...
  #define CC_DEFINE      "__WATCOMC__"
    ...
    #define cflagbuf   "build/watcom/win32/cflagbuf.h"
    #define CC_PROG      "wcc386"

  #elif defined(__SMALL__)
    #define CFLAGS       "build/watcom/small/cflags.h"
    #define cflagbuf   "build/watcom/small/cflagbuf.h"
    #define CC_PROG      "wcc"

  #elif defined(__LARGE__)
    #define CFLAGS       "build/watcom/large/cflags.h"
    #define cflagbuf   "build/watcom/large/cflagbuf.h"
    #define CC_PROG      "wcc"

  #elif defined(__FLAT__)
    #define CFLAGS       "build/watcom/flat/cflags.h"
    #define cflagbuf   "build/watcom/flat/cflagbuf.h"
    #define CC_PROG      "wcc386"
  ...
  #define CC_PROG        "cl"
    ...
    #error "Quick-C small/large model no longer supported."
        ...
        #define cflagbuf  "build/visualc/64bit/debug/cflagbuf.h"
      #else
        #define CFLAGS      "build/visualc/32bit/debug/cflags.h"
        #define cflagbuf  "build/visualc/32bit/debug/cflagbuf.h"
      #endif
    #else
      #if defined(_WIN64)
        #define CFLAGS      "build/visualc/64bit/release/cflags.h"
        #define cflagbuf  "build/visualc/64bit/release/cflagbuf.h"
      #else
        #define CFLAGS      "build/visualc/32bit/release/cflags.h"
        #define cflagbuf  "build/visualc/32bit/release/cflagbuf.h"
      #endif
    #endif
  #endif
#endif
