CFLAGS = -0 -lr -ml -opnr -oe=24 -oil+ -outback -ohm -sg -wx -we -d0 -k32768 -i=src -i=src/zlib --isrc/watt32/inc
CLIBS = watt32/bin/FILE.a zlib/zlib
...
fdnpkg16.exe: fdnpkg16.o crc32.o inf.o kprintf.o kittendj.o fileexst.o http.o libgz.o libunzip.o loadconf.o lsm.o net.o lzmadec.o pkgdb.o pkginst.o pkgsrch.o pkgrem.o readenv.o showinst.o getdelim.o rtrim.o parsecmd.o parseurl.o helpers.o
